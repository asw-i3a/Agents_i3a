...
public class RegisterController {
	...
	public ResponseEntity<String> register( @RequestBody Map<String, Object> payload ) {
		...
		Agent agent = new Agent( payload.get( "name" ).toString(),
		...
		return new ResponseEntity<String>( "{\"response\":\"agent registered\"}",
				HttpStatus.CREATED );
	}
