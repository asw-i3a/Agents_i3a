 ...
 * 
 */
package io.github.asw.i3a.agents.service.types;
...
public class AgentTest {
	...
	public void kindTest() throws IOException {
		...
		// Jorge was previously set to (2) Entity. Checking that both, the code
		// and the
		// resolution work.
		...
		// still
		// works.
		CSVFile originalFile = CSVFile.of( new URL( "src/main/resources/master.csv" ), ",", "id",
				"kind" );
		CSVFile testFile = CSVFile.of( new URL( "src/main/resources/master.csv" ), ",", "id",
				"kind" );
	...
	public void toStringTest() {
		...
		assertEquals( "{" + "agentId:'" + nico.getAgentId() + "',name:'" + nico.getName() + "',"
				+ "location:'" + nico.getLocation() + "'," + "email:'"
